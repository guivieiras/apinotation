...
var grammar = {
    ...
    {"name": "json", "symbols": [{"literal":"["}, "String", {"literal":"]"}], "postprocess": data => [data[1]]},
    {"name": "json$string$5", "symbols": [{"literal":"["}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "json$string$6", "symbols": [{"literal":" "}, {"literal":"]"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "json", "symbols": ["json$string$5", "String", "json$string$6"], "postprocess": data => [data[1]]},
